...
class appprodUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/structManager') {
            return array (  '_controller' => 'MakinMind\\EditorBundle\\Controller\\EditorController::manageStructureAction',  '_route' => 'EditorBundle_structManage',);
        }

        // EditorBundle_modifyFile
        if (0 === strpos($pathinfo, '/modifyFile') && preg_match('#^/modifyFile/(?P<id>\\d+)/(?P<fileName>[^/]+?)$#s', $pathinfo, $matches)) {
