...
\t\t\t\t\t\t<p>Salaire proposé : ";
            // line 29
            if (isset($context["contract"])) { $_contract_ = $context["contract"]; } else { $_contract_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_contract_, "amount"), "html", null, true);
            echo " euros</p>
\t\t\t\t\t\t<div class=\"tail\"></div>
\t\t\t\t\t</div>
