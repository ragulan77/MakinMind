...
class ProjectController extends Controller
{
    ...
    public function projectDevelopersListAction(Project $project)
    {
		...
		return $this->render('MakinMindProjectBundle:Project:owner_project_list_developers.html.twig', array('project'=> $project, 'contracts'=>$contracts));
    }
...
*/
    ...
    public function projectsListAction()
    {
    	...
    	return $this->render('MakinMindProjectBundle:Project:list_projects.html.twig', array("projects" => $projects));
    }
